...
class TrinitasLogger:
    ...
    def springfield(self, message: str, title: Optional[str] = None):
        ...
        if self.use_rich:
            ...
            if title:
                panel = Panel(text, title=f"[magenta]Springfield - {title}[/magenta]", 
    ...
    def krukai(self, message: str, title: Optional[str] = None):
        ...
        if self.use_rich:
            ...
            if title:
                panel = Panel(text, title=f"[blue]Krukai - {title}[/blue]", 
                            border_style="blue")
                self.console.print(panel)
            else:
    ...
    def vector(self, message: str, title: Optional[str] = None):
        ...
        if self.use_rich:
            ...
            if title:
                panel = Panel(text, title=f"[cyan]Vector - {title}[/cyan]", 
                            border_style="cyan")
                self.console.print(panel)
            else:
