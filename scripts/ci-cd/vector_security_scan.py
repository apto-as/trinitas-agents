...
class VectorSecurityScanner:
    ...
    def __init__(self, project_root: str):
        ...
        self.threat_categories = {
            "CRITICAL": {"weight": 50, "description": "即座にシステムが危険にさらされる"},
                ...
                try:
                    ...
                    for vuln in safety_data:
                        findings.append({
                            ...
                            "message": vuln.get("advisory", "依存関係に脆弱性があります"),
    ...
    def generate_vector_report(self) -> Dict:
        ...
        all_findings = secret_findings + dependency_findings + pattern_findings + permission_findings
...
def main():
    ...
    scanner = VectorSecurityScanner(project_root)
