...
class TestErrorScenarios(unittest.TestCase):
    ...
    def test_malformed_prompt_handling(self):
        ...
        self.assertFalse(analysis['parallelizable'], "Special chars should not trigger parallel")
    ...
    def test_agent_selection_edge_cases(self):
        ...
        all_keywords_prompt = "analyze security optimize performance test workflow quality"
    ...
    def test_missing_environment_variables(self):
        ...
        script_path = PROJECT_ROOT / 'hooks' / 'post-execution' / 'capture_subagent_result.sh'
    ...
    def test_timeout_handling(self):
        ...
        self.assertEqual(
            integrator.integrated_result['synthesis']['consensus_level'],
            'medium'
        )
    ...
    def test_concurrent_writes(self):
        ...
        self.assertEqual(len(result_files), 10, "All concurrent results should be captured")
...
class TestPerformance(unittest.TestCase):
    ...
    def test_prompt_analysis_speed(self):
        ...
        for prompt in prompts:
            ...
            self.assertLess(elapsed, 0.1, f"Analysis should be fast (<100ms): {elapsed:.3f}s")
            print(f"Analyzed '{prompt[:30]}...': {elapsed*1000:.1f}ms, {len(tasks)} tasks")
    ...
    def test_integration_speed(self):
        ...
        self.assertLess(elapsed, 1.0, f"Integration should be fast (<1s): {elapsed:.3f}s")
